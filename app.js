...
myLibrary[1] = new Book("The Hobbit","JRR Tolkein", 81532455, false);
myLibrary[2] = new Book("The Hobbit","JRR Tolfewqfwekein", 815, false);
myLibrary[3] = new Book("The Hofweqfwqefebbit","JRR Tolkein", 815, false);
...
const Modal = {
    ...
    addEvent: function() {
        ...
        // grabbing data
        Modal.enterBtn.addEventListener("click", addBookToLibrary(Modal.dataGrabber) )
        console.log(Modal.dataGrabber)
    },
